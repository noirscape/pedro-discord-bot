...
class Misc:
	...
	async def prunecheck(self,ctx):
		...
		pruneEmbed = discord.Embed(title="Amount of members that would be pruned", 
			...
			color=0x3c6694)
		pruneEmbed.set_footer(text="This embed is part of Pedro. © Ev1l0rd, 2017, GPLv3")
		pruneEmbed.set_thumbnail(url="https://pbs.twimg.com/media/DGVJ5QPUAAQmjU8.jpg:orig")
