...
Massive credits to the people above. I seriously cannot express that.
I'm so using this over the regular help.
I think it's under the GPLv3 (since the original one claims to be a
derivative of the discordpy one) so that should be just fine.
~evi"""
...
orig_help = None
wiki_link = '\nAlternatively, you may want to check out [the wiki](https://github.com/ev1l0rd/pedro-discord/wiki) which also has the full list of in-built commands.'
